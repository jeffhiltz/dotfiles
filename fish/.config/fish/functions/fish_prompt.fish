function fish_prompt --description 'Write out the prompt'
	...
	set -l arrows
	set arrows (set_color $fish_color_cwd) "❯" (set_color $fish_color_user) "❯" (set_color $fish_color_host) "❯"
	...
	echo -n -s ' ' (set_color $color_cwd) (prompt_pwd) $normal (__fish_git_prompt) $normal $prompt_status "$mode_str" " " $arrows " "
end
