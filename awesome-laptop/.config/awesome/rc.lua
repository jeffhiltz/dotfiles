...
awful.screen.connect_for_each_screen(function(s)
  ...
  -- Create the wibox
  s.mywibox = awful.wibar({ position = "bottom", screen = s, height = 47 }) -- TODO is there a way to use DPI here instead of hard-coding the height?
...
-- Start programs with autostart.sh
